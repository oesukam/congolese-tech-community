...
export default class FollowController {
  ...
  static async getFollowings (req, res) {
    ...
    .select('followed')
    .populate('followed', 'picture username')

    following = following.map(({ followed: { username, picture }}) => {
      return {
        username,
        picture,
      }
  ...
  static async getFollowers (req, res) {
    ...
    .select('follower')
    .populate('follower', 'picture username')

    follower = follower.map(({ follower: { username, picture }}) => {
      return {
        username,
        picture,
      }
